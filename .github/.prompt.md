...
Below are three example code snippets showing your expected style. **Please review and suggest modifications** if they don't match your preferences.
...
2. **Review examples** if needed: I'll show you code snippets matching your style
3. **Suggest modifications** before I implement: Let me know if naming, structure, or approach should change
4. **Implementation**: Once approved, I'll integrate the code into the appropriate module
5. **Iterate**: If refactoring is needed later, follow the same review-first approach

## Documentation Generation Policy

**Selective documentation approach:**
- **LuaDoc function/class signatures** (Examples 1 & 2): I can write these (function docs, @param, @return, @type fields)
- **Inline comments & design explanations** (Example 3): Only reformat what you provide—don't generate my own
  - Exception: Brief concept explanations for WoW API mechanics (e.g., "SavedVariables format: ...") are acceptable

---

## Questions or Customization Needed?

If these examples don't match your expectations, or if you'd like to adjust:
- Naming conventions
- Documentation placement
- Error handling approach
- Class structure patterns

**Just let me know.** I'll refine the examples and re-show them before writing any production code.
